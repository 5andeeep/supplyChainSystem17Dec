...
//        data.add(new Product(2, "HP", 8829));
...
//        tablePane.setStyle("-fx-background-color: #C0C0C0");
    ...
    public Product getSeletectedProduct(){
        try{
            Product seletectedProduct = productTable.getSelectionModel().getSelectedItem();
            return seletectedProduct;
        }catch (Exception e){
            e.printStackTrace();
        }
